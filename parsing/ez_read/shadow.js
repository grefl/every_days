const INVALID_ELEMENTS = ['SCRIPT', "HTML", "META", "TITLE", "LINK", "BODY", "DATA" ,"HEAD", "CODE", "-PRE", "HEADER", "STYLE", "IMG", "VIDEO"]

export function recursive(element, container) {
  const shadow = element.nodeName === '#text' ? document.createElement("span") : document.createElement(element.tagName)
